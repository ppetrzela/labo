...
kdataset       <- "./exp/FE8160/dataset_7130.csv.gz"
ksemilla_azar  <- 165391  #Aqui poner la propia semilla
ktraining      <- c(202010,202011,202012, 202101 )   #periodos en donde entreno
kfuture        <- c( 202103 )   #periodo donde aplico el modelo final


kexperimento   <- "KA_5rep_5folds"

ksemilla_primos  <-  165391
ksemillerio  <- 100

kmax_bin           <-    31
klearning_rate     <-     0.01139242
knum_iterations    <-   564
knum_leaves        <-   1023
kmin_data_in_leaf  <-  2825
kfeature_fraction  <-     0.2258087
...
#establezco donde entreno y predigo
dataset[ , train  := 0L ]
